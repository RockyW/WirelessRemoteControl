...
import com.meing.wdy.wirelessremote.R;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * WindowManager.LayoutParams.FLAG_FULLSCREEN);// 鍘绘帀淇℃伅鏍� *
		 ...
		 * status.setText("璇峰皢鏉＄爜缃簬鍙栨櫙妗嗗唴鎵弿銆�); status.setTextSize(14.0f);
		 * 
	...
	private void showResult(final Result rawResult, Bitmap barcode) {
		...
		builder.setTitle(getResources().getString(R.string.qr_type)
				+ rawResult.getBarcodeFormat() + "\n"
				+ getResources().getString(R.string.qr_result)
				+ rawResult.getText());
		builder.setPositiveButton(getResources().getString(R.string.qr_ok),
				new OnClickListener() {
		...
		builder.setNegativeButton(
				getResources().getString(R.string.qr_refresh),
				new OnClickListener() {
